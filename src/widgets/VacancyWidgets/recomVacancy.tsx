...
import { RecomBlockVacancy } from "../../pages/Vacancy/_components/vacancyPage/recomBlockVacancy"
import { VacancyApp } from "../../pages/Vacancy/_components/vacancyPage/type";
import { RecomSlider } from "../../pages/Vacancy/_components/vacancyPage/SliderRecom";
...
export const RecomVacancy: React.FC<VacancyApp> = ({ data }) => {
    ...
    return (
        <div>
            <div className="md:flex max-md:hidden space-x-8 max-xl:space-x-6 max-lg:space-x-4">
                {randomData.map((item) => (
                    <div key={item.id}>
