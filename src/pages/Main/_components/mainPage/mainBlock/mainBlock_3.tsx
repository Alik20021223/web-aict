  ...
  return (
    <div className='bg-white dark:bg-dark shadow-md  w-full p-[25px] 2xl:p-[35px] h-full  flex flex-col justify-between rounded-2xl'>
      <div className='flex flex-col justify-between items-start text-foreground'>
        <p className='xl:mb-[25px] lg:mb-[15px] 2xl:text-lg xl:text-describe-xl dark:text-white lg:text-describe-lg'>{data.date}</p>
        <h1 className='font-semibold lg:mb-5 2xl:text-2xl xl:file:mb-[30px] lg:text-lg xl:text-xl'>{data.name}</h1>
        <p className='xl:text-describe-xl 2xl:text-xl dark:text-white lg:text-describe-lg'>{data.describe}</p>
      </div>
