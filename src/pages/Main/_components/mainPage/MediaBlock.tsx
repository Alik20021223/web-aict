    ...
    return (
        <div className='md:w-[30%] max-sm:w-full max-md:last:mb-0 flex-col flex'>
            <Link to={data.link}>
                ...
                <div className='xl:p-[25px] md:p-[15px] max-md:p-6 2xl:p-[30px] lg:p-[15px]  flex flex-col bg-white text-textBlackAict shadow-md rounded-b-[10px]'>
                    {data.typePress && <div className='rounded-[5px] py-2.5 md:py-2 px-4 md:px-3 w-fit bg-grayAict '>
                        <p className='font-normal max-sm:text-sm max-md:text-lg xl:text-sm md:text-xs lg:text-xs 2xl:text-xl'>{data.typePress}</p>
                    </div>}
                    ...
                    <p className='mt-[30px] max-sm:text-sm 2xl:text-xl max-md:text-lg font-normal xl:text-base lg:text-sm md:text-xs opacity-70 text-[#2E363E]'>{data.date}</p>
                </div>
            </Link>
        </div>
    )
