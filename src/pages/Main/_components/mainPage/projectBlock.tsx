...
export const ProjectBlock: React.FC<ProjectApp> = ({ data }) => {
    return (
        <div className='py-10 max-sm:py-5 lg:py-6 lg:w-[30%] md:w-full max-md:last:mb-0 max-md:w-full shadow-md pl-7 max-lg:px-7 rounded-[10px] bg-white flex flex-col items-start'>
            <div>
            ...
            <div className='w-[80%] flex flex-col mt-6'>
                ...
                <p className='font-normal md:text-lg xl:text-sm lg:text-xs 2xl:text-lg text-[#2E363E]'>{data.describe}</p>
            </div>
            <a href={data.link}></a>
        </div>
    )
