          ...
          <div className="h-[400px] 2xl:h-[500px] bg-white dark:bg-dark rounded-xl p-[25px]" key={i}>
            <div className="h-full flex flex-1 flex-col justify-center items-center">
              <div className="flex flex-col flex-1">
                <h1 className="font-bold 2xl:text-4xl xl:text-2xl lg:text-xl lg:mb-3 text-foreground mb-5 2xl:mb-8">{slide.title}</h1>
                <p className="font-medium 2xl:text-2xl text-foreground">{slide.content}</p>
              </div>
