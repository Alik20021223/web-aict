        ...
        <div className="bg-white rounded-xl shadow-md">
            <div className="p-[110px] max-lg:p-10 space-y-[50px]">
                ...
                <div className="space-y-[50px] border-b-2 pb-10">
                    ...
                    <div dangerouslySetInnerHTML={{ __html: structureCenter }} className="text-[#53585E] max-sm:text-base sm:text-base  text-xl max-lg:text-lg leading-10"></div>
                </div>
                <div className="">
                    ...
                    <div className="text-[#53585E] text-xl max-lg:text-lg max-sm:text-base sm:text-base leading-10" dangerouslySetInnerHTML={{ __html: structureOrganize }}></div>
                </div>
            </div>
        </div>
    )
