...
interface RegulationsDocApp {
    data: documentBlockType[];
}

export const RegulationsDoc: React.FC<RegulationsDocApp> = ({ data }) => {
    ...
    return (
        <div className="rounded-xl shadow-md bg-white">
            <div className="lg:p-[77px] max-lg:p-12">
                <h1 className="font-bold max-lg:text-3xl text-4xl 2xl:text-5xl xl:mb-[70px] max-xl:mb-12">{t('RegulationsH1')}</h1>
